...
public class ExtentReportListener extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setDocumentTitle("Kamal");
		...
		extent.setSystemInfo("Name of tester: ", "Kamal");
		extent.setSystemInfo("Env", "Production");
		extent.setSystemInfo("Website", "Naveen Automation labs");
	...
	public void onTestSkipped(ITestResult tr) {
		test = extent.createTest(tr.getMethod().getMethodName());
		test.log(Status.SKIP, MarkupHelper.createLabel(tr.getName(), ExtentColor.GREEN));
